      ...
      text: TextSpan(
        ...
        children: <TextSpan>[
          TextSpan(
            ...
            style: TextStyle(fontWeight: FontWeight.normal, fontSize: 12, color: Theme.of(context).hintColor),
          ),
        ],
      ),
    );
...
class PreviewErrorListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      title: Text(error.raw, style: const TextStyle(decoration: TextDecoration.lineThrough)),

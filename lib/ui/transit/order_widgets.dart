...
abstract class TransitOrderList extends StatelessWidget {
  ...
  Widget _buildOrder(BuildContext context, OrderObject order) {
    return ListTile(
      leading: Padding(padding: const EdgeInsets.only(top: 4.0), child: Text(order.createTimeString)),
          ...
          await showDialog(
            ...
            builder: (context) {
              return SimpleDialog(
                ...
                children: [Padding(padding: const EdgeInsets.all(8.0), child: buildOrderView(context, detailedOrder))],
              );
            },
          );
        }
            ...
            children: [
              for (final header in headers)
                Padding(
                  ...
                  child: Text(header.toString(), style: const TextStyle(fontWeight: FontWeight.bold)),
                ),
            ],
          ),

                ...
                child: ConstrainedBox(
                  ...
                  child: Center(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          Text(S.printerMetaHelper, textAlign: TextAlign.center, style: theme.textTheme.titleMedium),
                          const SizedBox(height: kInternalSpacing),
                          SingleChildScrollView(scrollDirection: Axis.horizontal, child: buttons),
                          if (kDebugMode)
                            OutlinedButton(

  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Stack(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 24.0, top: 16, right: 24.0, bottom: 24.0),
            child: PrinterReceiptView(controller: controller, order: widget.order),
          ),
          Positioned.fill(
            child: AbsorbPointer(
              child: DecoratedBox(
                decoration: BoxDecoration(color: Colors.black.withAlpha(89), borderRadius: BorderRadius.circular(28)),

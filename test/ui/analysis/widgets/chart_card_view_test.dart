  ...
  group('Chart Card View', () {
    ...
    group('Cartesian Chart', () {
      testWidgets('edit to product with selection', (tester) async {
        ...
        await tester.pumpWidget(buildApp(Chart(type: AnalysisChartType.cartesian, id: 'test')));
    ...
    group('Circular Chart', () {
      ...
      testWidgets('all metrics are zero', (tester) async {
        ...
        await tester.pumpWidget(buildApp(Chart(type: AnalysisChartType.circular, target: OrderMetricTarget.catalog)));
        await tester.pumpAndSettle();
